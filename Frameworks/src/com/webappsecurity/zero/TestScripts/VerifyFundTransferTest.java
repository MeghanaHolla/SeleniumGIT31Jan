...
public class VerifyFundTransferTest extends Base{
	...
	public void verifyFundTransfer() throws IOException {
		...
		FundTransferVerify tfv = new FundTransferVerify(driver);
		FundTransferConfirmation tfc = new FundTransferConfirmation(driver);

		String[][] data = GenericMethods.getData("D:\\SelOct23\\TestData.xlsx", "Sheet1");
